...
\begin{document}
	...
	\author{
		Peter Rindal\inst{1} \and Roberto Trifiletti\inst{2}\thanks{The first author is supported by an ARCS foundation fellowship. This project has received funding from the European Union's Horizon 2020 research and innovation programme under grant agreement No 731583 (SODA).}
